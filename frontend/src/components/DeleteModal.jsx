...
import { deleteChat } from "../action/chatAction";
import Modal from "./Modal";

function DeleteModal({socket ,setOpenDeleteModal }) {
  ...
  const deleteChatController = () => {
    if (selectChat) {
      ...
      dispatch(deleteChat({ chatId: selectChat._id}, navigate,socket,selectChat));
