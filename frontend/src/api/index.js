...
export const deleteChatAPI = (data) => API.post(`/chat/delete`,data);
export const sentMessageAPI = (data) => API.post('/message',data);
export const addUserAPI = (data) => API.post(`/chat/add-user`,data);
export const updateUserAPI = (data) => API.post(`/user/update`,data);