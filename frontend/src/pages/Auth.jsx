...
function Auth() {
  ...
  return (
    <div className='w-full h-full bg-primary'>
        ...
        pauseOnHover
      />
        <div className='flex items-center justify-center h-28 bg-primary'>
        ...
        <div className='h-full overflow-y-auto bg-bgPrimary w-full flex flex-col py-16 justify-start items-center' style={{borderRadius:"120px 0 0 0"}}>
